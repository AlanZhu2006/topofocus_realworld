import re
from src.frontier_parser import patch_frontier_prompt
...
def form_prompt_for_DecisionVLM_Frontier(Scene_Information, agents_seg_list, pre_goal_point, target, cur_location, Frontier_list) -> str:
    ...
    # Step 4: patch prompt to force decision-first output format
    valid_candidates = [chr(65 + i) for i in range(len(Frontier_list))]
    User_Prompt = patch_frontier_prompt(User_Prompt, valid_candidates)
