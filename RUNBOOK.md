...
The checked-in workflow no longer embeds a dated map, calibration or tmux
identity. A new placement begins with one board-only command that persists the
...
holdout moved, deploys one checksummed calibration, creates fresh maps and
